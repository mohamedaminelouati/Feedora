    ...
    RYDialog(
        ...
        icon = {
            if (accountUiState.isLoading) {
                ...
                Icon(
                    modifier = Modifier.size(24.dp),
                    painter = painterResource(id = R.drawable.ic_miniflux),
                    contentDescription = stringResource(R.string.miniflux),
                )
            }
        },
        title = {
            Text(
                text = stringResource(R.string.miniflux),
                maxLines = 1,
        ...
        text = {
            Column(modifier = Modifier.verticalScroll(rememberScrollState())) {
                ...
                RYOutlineTextField(
                    ...
                    placeholder = "https://miniflux.example.com/v1/greader.php",
