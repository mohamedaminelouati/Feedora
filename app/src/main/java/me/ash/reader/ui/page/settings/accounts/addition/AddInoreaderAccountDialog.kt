...
fun AddInoreaderAccountDialog(
    ...
    RYDialog(
        ...
        visible = uiState.addInoreaderAccountDialogVisible,
        properties = DialogProperties(usePlatformDefaultWidth = false),
        onDismissRequest = {
            focusManager.clearFocus()
            accountViewModel.cancelAdd()
            viewModel.hideAddInoreaderAccountDialog()
        },
        icon = {
            if (accountUiState.isLoading) {
                ...
                Icon(
                    modifier = Modifier.size(24.dp),
                    painter = painterResource(id = R.drawable.ic_inoreader),
                    contentDescription = stringResource(R.string.inoreader),
                )
            }
        },
        title = {
            Text(
                text = stringResource(R.string.inoreader),
                maxLines = 1,
